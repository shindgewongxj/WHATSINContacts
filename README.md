...
- Those VCF ends with suffix **0** in the folder **simple** includes no numbers which are set for users who need customization.  
- Due to VCF multi-language unsupportted on Apple devices, you may need to edit names by yourself.  
